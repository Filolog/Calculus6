...
Report.write(
    "             <title>Вычислительный практикум</title>\n <script\n src=\"http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML\">")
Report.write("</script>\n </head>\n <body>\n")
...
Report.write(
    "\(x = " + solveCramer(A, b).toTexForm() + " ,\overline{x} = " + solveCramer(A, b + db).toTexForm() + "\) <br>")

Report.write("<i>Найти число обусловленности \( \mu (A) = ||A|| \cdot || A^{-1}||, \mu (A) = " + "{0:15.3f}".format(
    condNumber(A)) + "\) <i> <br>")
